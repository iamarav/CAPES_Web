...
<div class="display-4 mt-4 mb-4">Registration Form</div>
<?php 
if(isset($_POST['addc']))
{
...
elseif(mysqli_num_rows(mysqli_query($conn,$check2)))
{ 
  ?>
  <div class="alert alert-danger mt-4" role="alert">
...
<form action="signup.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-4 mx-auto mb-3">
                        <label for="imgc">Image/logo </label>
